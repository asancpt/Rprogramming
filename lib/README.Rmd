...
# Pending
install.packages("sources/Ttest.zip", lib = Path2, repos = NULL, type = "binary") # not MacOS
install.packages("sources/hw.zip", lib = Path2, repos = NULL, type = "binary") # not MacOS
install.packages("sources/IOLcal.zip", lib = Path2, repos = NULL, type = "binary") # not MacOS
