...
author: "Kyun-Seop Bae, Hyeongsuk Lim"
date: "`r Sys.Date()`"
...
아울러 수업 중에 사용한 코드/스크립트를 사용하여 R의 패키지인 `bookdown`을 사용해 웹북을 제작 중에 있습니다. 
...
출석 체크를 위해 전체메일을 사용하지 말아주십시오! Do not use r@acr.kr to prove your attendence!
```
